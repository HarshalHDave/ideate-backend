...
db.bid = require('./bid');
db.bid_report = require('./bid_report');
db.reports = require('./reports');
...
db.bid_report.belongsTo(db.bid, {
  foreignKey: 'bid_id',
  as: '_bid_id',
  targetKey: 'id' 
});
db.bid.hasMany(db.bid_report, {
  foreignKey: 'bid_id',
  sourceKey: 'id' 
});
db.bid_report.belongsTo(db.reports, {
  foreignKey: 'report_id',
  as: '_report_id',
  targetKey: 'id' 
});
db.reports.hasMany(db.bid_report, {
  foreignKey: 'report_id',
  sourceKey: 'id' 
});
...
db.bid_report.belongsTo(db.user, {
  foreignKey: 'addedBy',
  as: '_addedBy',
  targetKey: 'id' 
});
db.user.hasMany(db.bid_report, {
  foreignKey: 'addedBy',
  sourceKey: 'id' 
});
db.bid_report.belongsTo(db.user, {
